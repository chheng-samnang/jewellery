    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('admin/Main');?>">
                    <img src="<?php echo base_url('assets/img/admin_logo.png');?>" style="    width: 229px;
    margin-top: -16px;">
                </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li><a href="<?php echo base_url('')?>" target="_blank"><i class="fa fa-eye"></i> Preview</a></li>
