...
<script type="text/javascript" src=" <?php echo base_url('assets_frontend/js/jquery-3.2.1.min.js');?>"></script>
	...
	<div class="container">
		<div class="row">
			...
			<form action="<?php echo base_url('Search');?>" method="POST">
							...
							<input type="text" class="form-control" name="searchs" autocomplete="off" id="searchs" placeholder="Search Prducts or Category...">
						
						<span class="input-group-btn">
							<button class="btn btn-default" type="submit" id="btn-search"> <i class="fa fa-search" aria-hidden="true"></i> Search  </button>
						</span>
     					</div>
