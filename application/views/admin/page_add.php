							...
							foreach ($ctrl as $row) {
								if(!isset($row[0]['type']))
								{
									...
									elseif($row['type']=='upload')
									{
										...
										echo '<button type="button" class="btn btn-default btn-md" data-toggle="modal" data-target="#myModal"><i style="font-size: 26px;" class="fa fa-picture-o" aria-hidden="true"></i></button>';
									  ...
									  <div class="modal-dialog" role="document">
										<div class="modal-content">
										  ...
										  <div class="modal-body">
											<input class="form-control" type="file" name="txtUpload" multiple />
											<input type="hidden" id="txtImgName" name="txtImgName" />
											<input type="hidden" id="txtImgName1" name="txtImgName1" />
											<input type="hidden" id="txtImgName2" name="txtImgName2" />
											<input type="hidden" id="txtImgName3" name="txtImgName3" />
											<input type="hidden" id="txtImgName4" name="txtImgName4" />
											<input type="hidden" id="txtImgName5" name="txtImgName5" />
											<input type="hidden" id="txtImgName6" name="txtImgName6" />
											<input type="hidden" id="txtImgName7" name="txtImgName7" />
