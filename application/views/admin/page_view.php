                        ...
                        <tbody>
                            <?php $i=1;if(!empty($tbl_body[0])){foreach($tbl_body as $body)
                            {
                                echo "<tr>";                                    
                                    ...
                                    echo "<td>";
                            ?>
                                     	<?php if(isset($action_url[3])){ ?><a href="<?php if(isset($action_url)){echo base_url($action_url[3]).'/'.$body[$j];}?>" style="margin-right:5px" title="Change password"><i style="color: #39af39;" class="fa fa-lock"></i></a><?php }?>
                                        ...
                                        <?php if(isset($action_url[2])){ ?><a href="<?php if(isset($action_url)){echo base_url($action_url[2]).'/'.$body[$j];}?>" class="btn btn-large confirModal del" title="Delete" data-confirm-title="Confirm Delete !" data-confirm-message="Are you sure you want to Delete this ?"><i style="color: red;" class="fa fa-trash"></i></a><?php }?>                                        
                            <?php
                                    echo "</td>";                                    
                                echo "</tr>";
                            $i++;}}?>                            
